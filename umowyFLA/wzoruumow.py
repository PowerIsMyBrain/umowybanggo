contracts_data = {
        ...
        "Umowa o dzieło": {
            ...
            "strony_umowy": {
                "zleceniodawca": "Imię i nazwisko Zleceniodawcy",
                "wykonawca": "Imię i nazwisko Wykonawcy"
            },
            "paragrafy": [
                {
                    "tytul": "§1 Definicje",
                ...
                },
                {
                    ...
                    "tresc": "1. Wynagrodzenie za wykonanie dzieła wynosi X złotych (wliczając w to podatek VAT) i zostaje wypłacone Wykonawcy w terminie X dni od zakończenia wykonania dzieła na podstawie wystawionej faktury VAT.\n2. Strony ustalają, że wszelkie koszty związane z wykonaniem dzieła ponosi Zleceniodawca, chyba że postanowiono inaczej w niniejszej umowie."
                },
                {
                    "tytul": "§4 Termin wykonania dzieła",
                    "tresc": "1. Dzieło powinno być wykonane przez Wykonawcę najpóźniej do dnia X, chyba że strony umowy ustalą inny termin.\n2. W przypadku opóźnienia w wykonaniu dzieła, Wykonawca może podlegać karze umownej w wysokości X za każdy dzień zwłoki."
                },
                {
                    "tytul": "§5 Prawa autorskie",
                    "tresc": "1. Zleceniodawca oświadcza, że po opłaceniu wynagrodzenia za dzieło staje się on jego właścicielem i nabywa pełne prawa autorskie, w granicach określonych w polskim prawie autorskim."
                },
                {
                    "tytul": "§6 Odpowiedzialność",
                    "tresc": "1. Wykonawca ponosi odpowiedzialność za wady dzieła zgodnie z przepisami Kodeksu Cywilnego.\n2. Zleceniodawca zobowiązuje się do niezwłocznego zgłaszania wszelkich wad dzieła Wykonawcy, a ten zobowiązuje się do ich nieodpłatnego usunięcia w możliwie najkrótszym terminie."
                },
                {
                    "tytul": "§7 Postanowienia końcowe",
                    "tresc": "1. Wszelkie zmiany w niniejszej umowie wymagają formy pisemnej pod rygorem nieważności.\n2. Umowa wchodzi w życie z dniem podpisania przez obie strony i jest zawarta na czas określony do momentu wykonania dzieła.\n3. W sprawach nieuregulowanych niniejszą umową zastosowanie mają przepisy Kodeksu Cywilnego."
                }
            ]
        },
